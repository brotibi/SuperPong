...
int main()
{
    ...
    // this portion checks for shader compile errors
    ...
    // this portion checks for linking errors
    ...
    unsigned int indices[] = {  // note that we start from 0!
        0, 1, 3,  // Triangle 1
        1, 2, 3   // Triangle 2
    }; // OpenGL mainly uses Triangles to draw objects(I'm trying to draw a rectangle here)
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // Uses the Shader Program to draw a triangle
    ...
    // NOTE TO SELF I should probably move all the code above to an init function.
...
void processInput(GLFWwindow* window)
{
    ...
    if (glfwGetKey(window, GLFW_KEY_SPACE) == GLFW_PRESS) {
        glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);
        glClearColor(rand()%2, 0.3f, 0.3f, 1.0f);
    } else {
        glClearColor(0.8f, 0.3f, 0.3f, 1.0f);
